// Camera properties
detection_width = 200; // Width of the detection rectangle
detection_height = 100; // Height of the detection rectangle
alarm_duration = 120; // 2 seconds (60 frames = 1 second)
